...
3. To format the historical weather and outage CSVs: "./remove_headers.sh"
4. If conda environment is not installed: "./setup_virtual_environment.sh" to install Anaconda
