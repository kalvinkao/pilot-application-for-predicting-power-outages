This repository contains a pilot application created for the MIDS course W205 ("Storing and Retrieving Data").  The pilot application is a steel thread for an end-to-end solution for using weather data to predict power outages (including data engineering, machine learning, and visualization).  An overview of the process is contained in this folder (), and the steps below explain how you can test this application yourself using an AWS EC2 instance.
